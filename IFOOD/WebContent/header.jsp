...
<script defer src="resources/js/lib/fontawesome-all.min.js"></script>
      ...
      <div class="container-fluid">
        ...
        <section class="collapse navbar-collapse" id="myTogglerNav">
          <div class="navbar-nav ml-auto">
            <a class="nav-item nav-link" href="#page-hero"><svg xmlns="http://www.w3.org/2000/svg" width="16"
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-11 col-sm-10 col-md-8 animated fadeInUp">
            <h3 class="page-section-title">Enterprise Challenge IFOOD</h3>
          </div>
        </div>
      </div>
    </section>
